    ...
    if (!anime) {
        ...
        const plataformas = [
            {
                chave: 'Keep2Share',
                nome: 'Keep2Share',
               icone: '<img src="img/assets/Keep2Share.png" alt="Keep2Share" style="height: 1.1em; width: 1.1em;" />'
            },
            {
                chave: 'pixeldrain',
                nome: 'Pixeldrain',
        ...
        anime.episodios.forEach(ep => {
            ...
            `;
                    ...
                    // Adiciona os atributos para rastreamento
                    a.dataset.anime = anime.titulo;
                    a.dataset.episodio = ep.numero;
                    a.dataset.plataforma = plataforma.nome;

                    // Evento de clique para GA4
                    a.addEventListener('click', () => {
                        gtag('event', 'clique_download', {
                            event_category: 'download',
                            event_label: anime.titulo,
                            episodio: ep.numero,
